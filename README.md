...
**[https://amgijwi.com](https://amgijwi.com)** (테스트 페이지)
...
| 기능 | 설명 |
|---|---|
| **학습** | 카드 뒤집기 / 빈칸 채우기 두 가지 방식. 범위 안에서 외울 레시피만 골라서 돌릴 수 있습니다 |
...
| **개봉관리** | 개봉한 재료의 기한을 등록하면 홈에서 오늘 폐기할 것을 알려줍니다 |
| **소리** | 효과음과 배경음. 기본은 꺼짐이고 설정 탭에서 켭니다. 배경음은 켜 두면 앱을 쓰는 동안 계속 흐릅니다 |
